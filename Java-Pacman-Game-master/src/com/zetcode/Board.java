...
public class Board extends JPanel implements ActionListener {
    ...
    private final int MAX_GHOSTS = 20; //valor aletrado de 12 para 20
    private final int PACMAN_SPEED = 6;

    private int pacAnimCount = PAC_ANIM_DELAY;
    private int pacAnimDir = 1;
    private int pacmanAnimPos = 0;
    private int N_GHOSTS = 2; //valor alterado de 6 para 2
    ...
    private final int validSpeeds[] = { 3, 4, 6, 8, 12, 15};//adicionada a velocidade 12
    ...
    private void checkMaze() {
        ...
        if (finished) {
            ...
            // adiciona 2 fantasma e 1 vida a mais a cada round ganho
            N_GHOSTS +=2;
            pacsLeft++;
